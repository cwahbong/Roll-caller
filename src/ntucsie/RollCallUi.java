...
public class RollCallUi extends JFrame {
	...
	public Timer getSpinRollTimer() {
		if(_spinRollTimer==null) {
			_spinRollTimer = new Timer(1, new ActionListener() {
				RollTask st = new RollTask(0);
				RollTask nd = new RollTask(1);
				RollTask rd = new RollTask(2);
...
private class RollTask extends TimerTask {
		...
		public RollTask(int order) {
			...
			//getCenterPanel().add(((CenterPanel) getCenterPanel()).getRollTextArea(_order));
